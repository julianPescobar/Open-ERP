...
namespace FLAGSYSTEMPV_2017
{
    public partial class NotaDeCredito : Form
    {
        ...
        private void Ventas_Load(object sender, EventArgs e)
        {
            ...
            nextid = Conexion.Consultar("AUTOINC_NEXT", "INFORMATION_SCHEMA.COLUMNS", " WHERE (TABLE_NAME = 'NotaCreds') AND (COLUMN_NAME = 'idventa')", "", new SqlCeCommand());
            Conexion.cerrar();
            textBox1.Text = nextid.Rows[0][0].ToString();
            totalventa.idnotacred= Convert.ToInt32(nextid.Rows[0][0].ToString());
        ...
        private void textBox4_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (dataGridView1.Rows.Count > 0 && textBox4.Text.Length == 0)
                {
                    ...
                    totalventa.detallenotacred = dt;

                    
                    totalventa.totnotacred = textBox5.Text;
